...
export const ProductSchema = z.object({
    ...
    stock_quantity: z.number().min(0, { message: "Stock quantity must be a non-negative number" }),
});
...
export const UpdateProductSchema = z.object({
  ...
  stock_quantity: z.number().min(0, { message: "Stock quantity must be a non-negative number" }).optional(),
});
